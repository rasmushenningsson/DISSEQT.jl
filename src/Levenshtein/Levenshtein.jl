# TODO: depend on Levenshtein package rather than including here (when the package is fixed and a julia 1.1 version is released). See LICENSE.md in this folder for Levenshtein license (MIT license).
